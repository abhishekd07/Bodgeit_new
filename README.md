...
Note that the BodgeIt Store is now available as a Docker image: https://hub.docker.com/r/psiinon/bodgeit/ #Hello World
...
* Easy to change on the fly - all the functionality is implemented in JSPs, so no IDE required #test cxgo
* Cross platform
* Open source
